...
namespace OpenGLTutorial5
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Glut.glutCreateWindow("desenhando");
            ...
            //funçao de mapear o triangulo
            DrawTriangle();
            //função de mapear o quadrado
            DrawQuads();
            watch = System.Diagnostics.Stopwatch.StartNew();
            // manter a janela aberta enquanto n encerrar o programa
            Glut.glutMainLoop();
        }
        ...
        private static void OnRenderFrame()
        {
            ...
            // angulo de rotação dos objetos
            angle += deltaTime;

            // mapeia as coordenadas da janela
